...
with sq.connect("apteka.db") as con:
    cur = con.cursor()
    cur.executemany("INSERT INTO lekarstvennie_sredstva VALUES (?, ?, ?, ?, ?)", info.lekarstva)
...
with sq.connect("apteka.db") as con:
    cur = con.cursor()
    cur.executemany("INSERT INTO nalichie_na_sklade VALUES (?, ?, ?)", info.nalichie)
...
with sq.connect("apteka.db") as con:
    cur = con.cursor()
    cur.executemany("INSERT INTO aptechniy_punkt VALUES (?, ?, ?, ?, ?, ?)", info.aptechniy_punkt)
